...
const Product = ({item}) => {
  return (
    <div className='max-w-82.5 relative group'>
      ...
      <div>
          <h3 className='text-sm font-jost font-normal leading-6 text-third mt-3.5'>{ item.category}</h3>
          ...
          <div className='flex gap-2.5'>
            ...
            <h4 className='text-base font-jost font-normal text-redcolor'>${item.price }</h4>
        </div>
      </div>
