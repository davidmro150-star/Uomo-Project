...
const ShopSingleGrouped = () => {
  ...
  return (
    ...
    <div className="flex flex-col gap-12 lg:flex-row">
      ...
      <div className="lg:w-1/2">
            <h1 className="mb-2  font-regular text-primary-black  text-[26px] font-jost ">
            {product.title}
            </h1>

            <p className="mb-4  font-jost font-medium text-primary-black  text-[22px] ">
            ${product.price}
            </p>

            <p className="font-jost font-regular text-primary-black  text-[14px] mt-6.25 mb-7.25 leading-6">{product.description}</p>

                {/* Quantity */}
                
                  
                <div className="mb-6 flex items-center gap-5">
                <div className="flex items-center border text-black font-bold">
            <button
      ...
      <button className="w-60 h-10 items-center bg-black py-3 text-white font-jost text-[16px] ">
            Add to Cart
      </button>
            </div>
    ...
    This product does not have any reviews yet. Be the first customer to share your experience.
    </p>
    </div>
    )}
    </div>
